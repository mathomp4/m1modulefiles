...
ml clang-gfortran/15.1.0

mkdir build-clang-gfortran-15.1.0 && cd build-clang-gfortran-15.1.0

../configure --disable-wrapper-rpath --disable-wrapper-runpath \
  CC=clang CXX=clang++ FC=/Users/mathomp4/installed/Core/gcc-gfortran/15.1.0/bin/gfortran \
  --with-hwloc=internal --with-libevent=internal --with-pmix=internal \
  --prefix=$HOME/installed/Compiler/clang-gfortran-15.1.0/openmpi/5.0.7 |& tee configure.clang-gfortran-15.1.0.log

mv config.log config.clang-gfortran-15.1.0.log
make -j6 |& tee make.clang-gfortran-15.1.0.log
make install |& tee makeinstall.clang-gfortran-15.1.0.log
make check |& tee makecheck.clang-gfortran-15.1.0.log

--]]

family("MPI")
prereq("clang-gfortran/15.1.0")

local compilername = "clang-gfortran-15.1.0"
...
local mdir = pathJoin(mroot,"MPI/clang-gfortran-15.1.0",("openmpi-"..version))
