...
mkdir build-gcc-gfortran-15 && cd build-gcc-gfortran-15

../configure --disable-wrapper-rpath --disable-wrapper-runpath \
  CC=gcc-15 CXX=g++-15 FC=gfortran-15 \
  --with-hwloc=internal --with-libevent=internal --with-pmix=internal \
  --prefix=$HOME/installed/Compiler/gcc-gfortran-15/openmpi/5.0.7 |& tee configure.gcc-gfortran-15.log

mv config.log config.gcc-gfortran-15.log
make -j6 |& tee make.gcc-gfortran-15.log
make install |& tee makeinstall.gcc-gfortran-15.log
make check |& tee makecheck.gcc-gfortran-15.log

--]]

family("MPI")
prereq("gcc-gfortran/15")
...
local mdir = pathJoin(mroot,"MPI/gcc-gfortran-15",("openmpi-"..version))
