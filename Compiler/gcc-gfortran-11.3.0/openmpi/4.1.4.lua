...
-- $ mkdir build-gcc-gfortran-11.3.0 && cd build-gcc-gfortran-11.3.0
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran \
--    --prefix=$HOME/installed/Compiler/gcc-gfortran-11.3.0/openmpi/4.1.4 |& tee configure.gcc-gfortran-11.3.0.log
