...
-- $ mkdir build-gcc-gfortran-11.2.0 && cd build-gcc-gfortran-11.2.0
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran --prefix=$HOME/installed/Compiler/gcc-gfortran-11.2.0/openmpi/4.1.3 |& tee configure.gcc-gfortran-11.2.0.log
...
local mdir = pathJoin(mroot,"MPI/gcc-gfortran-11.2.0",("openmpi-"..version))
