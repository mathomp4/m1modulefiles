...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-12/openmpi-5.0.5/Baselibs/8.5.0/Darwin |& tee makeinstall.clang-gfortran-12_openmpi-5.0.5.log
...
family("Baselibs")
prereq("clang-gfortran/12", "openmpi/5.0.5")
