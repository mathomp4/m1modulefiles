...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-13.1.0/openmpi-4.1.5/Baselibs/7.12.0/Darwin |& tee makeinstall.gcc-gfortran-13.1.0_openmpi-4.1.5.log
--
-- If you want to check:
--
-- $ make check ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-13.1.0/openmpi-4.1.5/Baselibs/7.12.0/Darwin |& tee makecheck.gcc-gfortran-13.1.0_openmpi-4.1.5.log
--
