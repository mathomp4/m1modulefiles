...
-- $ make -j3 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12.1.0/openmpi-4.1.4/Baselibs/6.2.13/Darwin |& tee makeinstall.gcc-gfortran-12.1.0_openmpi-4.1.4.log
--
...
family("Baselibs")
--prereq("gcc-gfortran/12.1.0", "openmpi/4.1.4")
