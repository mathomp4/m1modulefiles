...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang ESMF_BOPT=g prefix=$HOME/installed/MPI/clang-gfortran-16/openmpi-5.0.10/Baselibs/8.33.0/Darwin |& tee makeinstall.clang-gfortran-16_openmpi-5.0.10.log
