...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=llvm ESMF_BOPT=g prefix=$HOME/installed/MPI/appleclang-flang-22/openmpi-5.0.10/Baselibs/9.12.0/Darwin |& tee makeinstall.appleclang-flang-22_openmpi-5.0.10.log
