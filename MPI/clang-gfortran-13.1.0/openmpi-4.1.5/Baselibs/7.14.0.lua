...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-13.1.0/openmpi-4.1.5/Baselibs/7.14.0/Darwin |& tee makeinstall.clang-gfortran-13.1.0_openmpi-4.1.5.log
--
