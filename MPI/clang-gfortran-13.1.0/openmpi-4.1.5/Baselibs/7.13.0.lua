...
--
--   git clone -j 4 --recurse-submodules -b v7.13.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-7.13.0/src
--
-- This was built using:
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-13.1.0/openmpi-4.1.5/Baselibs/7.13.0/Darwin |& tee makeinstall.clang-gfortran-13.1.0_openmpi-4.1.5.log
--
...
family("Baselibs")
--prereq("clang-gfortran/13.1.0", "openmpi/4.1.5")
