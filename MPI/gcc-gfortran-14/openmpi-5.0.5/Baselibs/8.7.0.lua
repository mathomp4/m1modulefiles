...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-14/openmpi-5.0.5/Baselibs/8.7.0/Darwin |& tee makeinstall.gcc-gfortran-14_openmpi-5.0.5.log
...
family("Baselibs")
prereq("gcc-gfortran/14", "openmpi/5.0.5")
