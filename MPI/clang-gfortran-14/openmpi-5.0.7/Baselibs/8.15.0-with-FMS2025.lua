...
This was cloned with:
  ...
  git clone -j 4 --recurse-submodules -b v8.15.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.15.0/src

This was built using:

make -j6 install ESMF_COMM=openmpi ESMF_BOPT=g ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-14/openmpi-5.0.7/Baselibs/8.15.0-with-FMS2025/Darwin |& tee makeinstall.clang-gfortran-14_openmpi-5.0.7.log
