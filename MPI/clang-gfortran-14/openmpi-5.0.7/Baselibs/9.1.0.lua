...
This was cloned with:
  ...
  git clone -j 4 --recurse-submodules -b v9.1.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-9.1.0/src

This was built using:

ml clang-gfortran/14 openmpi/5.0.7

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-14/openmpi-5.0.7/Baselibs/9.1.0/Darwin |& tee makeinstall.clang-gfortran-14_openmpi-5.0.7.log
