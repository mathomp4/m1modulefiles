...
This was cloned with:
  ...
  git clone -j 4 --recurse-submodules -b v7.32.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-7.32.0/src

This was built using:

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-14/openmpi-4.1.8/Baselibs/7.32.0/Darwin |& tee makeinstall.clang-gfortran-14_openmpi-4.1.8.log
