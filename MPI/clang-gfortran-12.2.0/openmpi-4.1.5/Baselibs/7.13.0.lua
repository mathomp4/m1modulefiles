...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-12.2.0/openmpi-4.1.5/Baselibs/7.13.0/Darwin |& tee makeinstall.clang-gfortran-12.2.0_openmpi-4.1.5.log
--
