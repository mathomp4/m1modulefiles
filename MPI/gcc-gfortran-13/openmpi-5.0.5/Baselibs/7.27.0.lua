...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-13/openmpi-5.0.5/Baselibs/7.27.0/Darwin |& tee makeinstall.gcc-gfortran-13_openmpi-5.0.5.log
...
family("Baselibs")
prereq("gcc-gfortran/13", "openmpi/5.0.5")
