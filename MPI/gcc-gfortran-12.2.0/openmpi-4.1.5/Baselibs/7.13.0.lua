...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12.2.0/openmpi-4.1.5/Baselibs/7.13.0/Darwin |& tee makeinstall.gcc-gfortran-12.2.0_openmpi-4.1.5.log
--
