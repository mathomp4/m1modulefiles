...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=llvm ESMF_BOPT=g prefix=$HOME/installed/MPI/appleclang-flang-23/openmpi-5.0.10/Baselibs/9.13.0/Darwin |& tee makeinstall.appleclang-flang-23_openmpi-5.0.10.log
