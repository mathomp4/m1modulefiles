...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-15.1.0/openmpi-5.0.7/Baselibs/8.14.0/Darwin |& tee makeinstall.gcc-gfortran-15.1.0_openmpi-5.0.7.log
