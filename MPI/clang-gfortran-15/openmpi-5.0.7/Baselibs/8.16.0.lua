...
make -j6 install ESMF_COMM=openmpi ESMF_BOPT=g ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-15/openmpi-5.0.7/Baselibs/8.16.0/Darwin |& tee makeinstall.clang-gfortran-15_openmpi-5.0.7.log
