...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12/openmpi-5.0.2/Baselibs/7.23.0/Darwin |& tee makeinstall.gcc-gfortran-12_openmpi-5.0.2.log
--
