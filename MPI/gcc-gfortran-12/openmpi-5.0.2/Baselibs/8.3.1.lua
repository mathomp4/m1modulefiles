...
This was cloned with:
  ...
  git clone -j 4 --recurse-submodules -b v8.3.1 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.3.1/src

This was built using:

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12/openmpi-5.0.2/Baselibs/8.3.1/Darwin |& tee makeinstall.gcc-gfortran-12_openmpi-5.0.2.log
...
family("Baselibs")
prereq("gcc-gfortran/12", "openmpi/5.0.2")
