...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12/openmpi-5.0.0/Baselibs/7.17.0/Darwin |& tee makeinstall.gcc-gfortran-12_openmpi-5.0.0.log
--
...
family("Baselibs")
prereq("gcc-gfortran/12", "openmpi/5.0.0")
