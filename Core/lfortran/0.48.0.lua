...
bash Miniforge3-$(uname)-$(uname -m).sh -b -p /Users/mathomp4/installed/Core/lfortran/0.48.0
/Users/mathomp4/installed/Core/lfortran/0.48.0/bin/mamba create -p /Users/mathomp4/installed/Core/lfortran/0.48.0/envs/lf
/Users/mathomp4/installed/Core/lfortran/0.48.0/bin/mamba install -n lf -y -c conda-forge lfortran
...
local mdir  = pathJoin(mroot,"Compiler/lfortran-0.48.0")
