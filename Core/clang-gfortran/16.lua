-- stub routine for clang + gfortran-16 from brew
--
-- install gcc-16 via:
--   brew install gcc@16
...
local mdir  = pathJoin(mroot,"Compiler/clang-gfortran-16")
prepend_path("MODULEPATH", mdir)

setenv("CC",pathJoin(cbindir,"clang"))
setenv("CXX",pathJoin(cbindir,"clang++"))
setenv("FC",pathJoin(fbindir,"gfortran-16"))
setenv("F90",pathJoin(fbindir,"gfortran-16"))
