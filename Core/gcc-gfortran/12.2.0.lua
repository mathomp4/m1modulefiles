-- stub routine for gcc-gfortran 12.2.0 ON M1 --
-- 
-- This was based on the M1 work from @iains (see https://github.com/iains/gcc-11-branch/issues/3#issuecomment-1141065779)
--
--   https://github.com/iains/gcc-12-branch/tree/gcc-12.2-darwin-r0
--
-- So cloned that branch:
--
--   git clone -b gcc-12.2-darwin-r0 git@github.com:iains/gcc-12-branch.git
--
-- Next, run:
--   
--   cd gcc-12-branch/
...
--
--   cd ..
--   mkdir build-gcc-12.2-from-git && cd build-gcc-12.2-from-git
...
local mdir  = pathJoin(mroot,"Compiler/gcc-gfortran-12.2.0")
