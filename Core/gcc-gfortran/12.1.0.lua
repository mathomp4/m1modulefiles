-- stub routine for gcc-gfortran 12.1.0 ON M1 --
-- 
...
--
--   git clone -b gcc-12-1-darwin-pre-r1 git@github.com:iains/gcc-12-branch.git
--
-- Next, run:
--   
--   cd gcc-12-branch/
...
--
--   cd ..
--   mkdir build-gcc-12.1-from-git && cd build-gcc-12.1-from-git
--   ../gcc-12-branch/configure --prefix=$HOME/installed/Core/gcc-gfortran/12.1.0 \
...
local mdir  = pathJoin(mroot,"Compiler/gcc-gfortran-12.1.0")
