-- stub routine for gcc-gfortran 13.1.0 ON M1 --
-- 
-- This was based on the M1 work from @iains (see https://github.com/iains/gcc-11-branch/issues/3#issuecomment-1141065779)
--
--   https://github.com/iains/gcc-13-branch/releases/tag/gcc-13.1-darwin-r0
--
-- So cloned that branch:
--
--   git clone -b gcc-13.1-darwin-r0 git@github.com:iains/gcc-13-branch.git gcc-13.1-darwin-r0
--
-- Next, run:
--   
--   cd gcc-13.1-darwin-r0
...
--
--   cd ..
--   mkdir build-gcc-13.1-darwin-r0 && cd build-gcc-13.1-darwin-r0
--   ../gcc-13.1-darwin-r0/configure --prefix=$HOME/installed/Core/gcc-gfortran/13.1.0 \
...
local mdir  = pathJoin(mroot,"Compiler/gcc-gfortran-13.1.0")
