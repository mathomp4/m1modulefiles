...
and I ran
  ...
  ./install_miniforge.bash --python_version 3.14 --miniforge_version 25.11.0-1 --prefix /Users/mathomp4/installed/Core/GEOSpyD |& tee install.25.11.0-1_py3.14.log
...
local miniforge_version = "25.11.0-1"
local python_version = "py3.14"
local builddate = "2025-12-10"
