...
and I ran
  ...
  ./install_miniforge.bash --python_version 3.11 --miniforge_version 24.7.1-2 --prefix /Users/mathomp4/installed/Core/GEOSpyD |& tee install.24.7.1-2_py3.11.log
...
local miniforge_version = "24.7.1-2"
local python_version = "py3.11"
local builddate = "2024-10-15"
