...
and I ran
  ...
  ./install_miniforge.bash --python_version 3.14 --miniforge_version 26.5.3-0 --prefix /Users/mathomp4/installed/Core/GEOSpyD |& tee install.26.5.3-0_py3.14.log
...
local miniforge_version = "26.5.3-0"
local python_version = "py3.14"
local builddate = "2026-09-08"
