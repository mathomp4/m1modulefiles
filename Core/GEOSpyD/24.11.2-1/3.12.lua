...
and I ran
  ...
  ./install_miniforge.bash --python_version 3.12 --miniforge_version 24.11.2-1 --prefix /Users/mathomp4/installed/Core/GEOSpyD |& tee install.24.11.2-1_py3.12.log
...
local miniforge_version = "24.11.2-1"
local python_version = "py3.12"
local builddate = "2025-01-22"
